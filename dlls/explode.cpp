...
/*	if ( !( pev->spawnflags & SF_ENVEXPLOSION_NOFIREBALL ) )
	...
	if ( !( pev->spawnflags & SF_ENVEXPLOSION_NOFIREBALL ) )
		sprScale = m_spriteScale;
	else
		sprScale = 0;

	PLAYBACK_EVENT_FULL( NULL, NULL, g_sExplode, 0.0, (float*)&vecSpot, (float*)&g_vecZero, 0.0, 0.0, sprScale, 0, 0, 0);
	...
	ExplodeModel( pev->origin, 400, 0, 30 );
}
