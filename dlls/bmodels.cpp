...
//#define		SF_BRUSH_NOPUSHABLES	1024 // don't hurt pushables
...
void CFuncRotating :: HurtTouch ( CBaseEntity *pOther )
{
	...
	if ( pevOther->movetype == MOVETYPE_NOCLIP )
		return;	// they're not exactly touching us, ignore them

	// don't call takedamage for no reason
