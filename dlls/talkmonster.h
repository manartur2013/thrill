...
public:
	...
	int				ObjectCaps( void ) { return CBaseMonster :: ObjectCaps() | FCAP_USE_THROUGH_BSP; }
	void			Precache( void );
	...
	float		m_flNextCantFollowSentence;// when next "i cant follow you" sentence can be played, probably won't even save/restore that
	float		m_flNextHearForget;// when monster can comment on sound once again. SAVE this?
