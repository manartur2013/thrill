...
public:
	...
	float				m_flDistDieForward;
	float				m_flDistDieBackward;

	BOOL				m_fThrowCorpse; // should we give a dead body some velocity
...
// stuff written for new state machine
	...
	virtual int		MainGib( void ); /*{ return MAINGIB_NONE; }*/
	virtual int		SpecialGib( void ) { return SPECIALGIB_NONE; }
	virtual int		StickyGib( void ); /*{ return STICKYGIB_NONE; }*/
	virtual BOOL	HasHumanGibs( void );
	virtual BOOL	HasAlienGibs( void );
/*	virtual BOOL	HasGruntGibs( void ) { return FALSE; }
	virtual BOOL	HasZombieGibs( void ) { return FALSE; }
	virtual BOOL	HasHoundeyeGibs( void ) { return FALSE; }
	virtual BOOL	HasAGruntGibs( void ) { return FALSE; }*/
	...
	virtual BOOL IsHeavyDamage( float flDamage ) { return flDamage >= 20; /*return flDamage / pev->health >= 0.25;*/ }
	virtual BOOL IsLightDamage( float flDamage ) { return flDamage >= 0 && !IsHeavyDamage(flDamage); }

	virtual BOOL ShouldThrowCorpse( void ) { return TRUE; }
